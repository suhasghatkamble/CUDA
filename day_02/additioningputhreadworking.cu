...
int main(){
    ...
    //addIntegers <<<1,5>>> (device_a, device_b, device_result);  //5threads run IN 1 BLOCK
    //addIntegers <<<5,1>>> (device_a, device_b, device_result);  // 1 THREAD IN EACH 5 BLOCK 
    //addIntegers <<<5,5>>> (device_a, device_b, device_result); // 5 THREAD IN EACH 5 BLOCKS
    //addIntegers <<<1,1025>>> (device_a, device_b, device_result); //MAXIMUM LIMIT IS CROSSED LIMIT IS 1024
    addIntegers <<<1,1024>>> (device_a, device_b, device_result);// MAXIMUM 1 BLOCK CONTAIN 1024 THREADS
