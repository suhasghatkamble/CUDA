...
int main() {
  ...
  //Creating two array for doing addition of those
  ...
  //for a grid
  int numBlocksX = (N + threadsPerBlockX - 1) / threadsPerBlockX;//1
  int numBlocksY = (M + threadsPerBlockY - 1) / threadsPerBlockY;//1
